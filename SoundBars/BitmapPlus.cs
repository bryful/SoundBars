 ...
 * http://nonsoft.la.coocan.jp/SoftSample/CS.NET/SampleBitmapPlus.html
 * にあったサンプルをそのまま使用
 * 
 */
...
namespace SoundBars
{
    ...
    class BitmapPlus
    {
		...
		public int LineValue(int y)
		{
			...
			{
	            byte b = System.Runtime.InteropServices.Marshal.ReadByte(adr, pos);
				if (b < 128)
				{
					idx = x;
					break;
